    ...
    initializeChart: ({ timeSeriesData, dimensions, duration }) => {
        ...
        const xAxis = (g) =>
            g
                ...
                .call(
                    d3.axisBottom(x).tickValues(getTickValues(data, c.limit)).tickFormat(tickFormat).tickSizeOuter(0),
                );
        ...
        const yAxis = (g) =>
            g
                ...
                .call(
                    d3.axisLeft(y).tickFormat(d3.format('$~f')).tickValues(d3.scaleLinear().domain(y.domain()).ticks()),
                )
                .call((g) =>
                    g
                        .selectAll('.tick line')
