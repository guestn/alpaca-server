...
export const localStorageKey = 'Alpaca-Prefs';

export const setLocalStorage = (item) => {
    const alpacaPrefs = getLocalStorage();
    localStorage.setItem(localStorageKey, JSON.stringify({ ...alpacaPrefs, ...item }));
};

export const getLocalStorage = () => {
    const alpacaPrefs = JSON.parse(localStorage.getItem(localStorageKey));
    return alpacaPrefs || {};
};
